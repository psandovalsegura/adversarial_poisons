...
trainset = torchvision.datasets.CIFAR10(root=args.cifar_path, train=True, download=False, transform=transform_train)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True, **kwargs)
testset = torchvision.datasets.CIFAR10(root=args.cifar_path, train=False, download=False, transform=transform_test)
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % args.save_freq == 0 or epoch == args.epochs:
            ...
            print(f'==> Saving model at epoch {epoch} to {ckpt_save_path}')
