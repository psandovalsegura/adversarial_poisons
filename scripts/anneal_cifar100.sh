...
#SBATCH --job-name=advpoison-cifar100
...
python anneal.py --recipe targeted \
                 ...
                 --budget 1.0 \
                 --dataset CIFAR100 \
                 --data_path /vulcanscratch/psando/cifar-100 \
                 --checkpoint_directory /fs/vulcan-projects/stereo-detection/unlearnable-ds-neurips-23/adversarial_poisons_checkpoints \
                 --save_final_checkpoint \
                 --save poison_dataset \
                 --poison_path /fs/vulcan-projects/stereo-detection/psando_poisons/paper/cifar100/error-max \
                 --restarts 3 \
                 --attackoptim PGD
